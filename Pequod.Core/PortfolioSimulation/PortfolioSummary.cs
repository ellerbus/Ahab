...
{
    /// <summary>
    /// A summary of the portfolio simulation
    /// </summary>
    public sealed class PortfolioSummary
    {
        #region Constructors

        public PortfolioSummary(IPortfolioModel model, PortfolioLedger portfolio, IList<Signal> signals)
        {
            Model = model;
            Portfolio = portfolio;
            Signals = signals;
        ...
        /// </summary>
        public PortfolioLedger Portfolio { get; private set; }
